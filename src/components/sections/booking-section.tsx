...
export function BookingSection() {
  return (
    ...
    >
      ...
      <Reveal className="relative z-10 flex flex-col items-center gap-8 border border-primary/10 bg-surface/80 p-12 px-margin-mobile text-center backdrop-blur-md md:p-24">
        <h2 className="max-w-2xl font-display-md text-headline-lg-mobile leading-tight text-primary md:text-display-md">
          LLEVA EL ESPECTÁCULO A TU ESPACIO.
        </h2>
        <div className="my-4 h-px w-16 bg-primary" />
        <p className="mb-4 max-w-lg font-body-lg text-body-lg text-on-surface-variant">
