  ...
  return (
    <section className="border-y border-primary/10 bg-surface-container-low px-margin-mobile py-stack-xl md:px-margin-desktop">
      <Reveal className="mx-auto flex max-w-[1440px] flex-col items-center gap-16">
        <h2 className="text-center font-display-md text-headline-lg-mobile text-primary md:text-display-md">
          El Dúo
        </h2>
        ...
        <div className="grid w-full max-w-5xl grid-cols-1 gap-gutter md:grid-cols-2">
          {DANCERS.map((dancer) => (
            ...
            >
              <GrainImage
                className="relative aspect-[4/5] w-full overflow-hidden border border-primary/10"
                src={dancer.src}
                alt={dancer.alt}
              ...
              <div className="text-center md:text-left">
                ...
                <p className="mt-2 font-label-sm text-label-sm uppercase tracking-widest text-on-surface-variant">
                  {dancer.role}
                </p>
              </div>
            </div>
