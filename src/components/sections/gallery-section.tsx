...
const GALLERY_ITEMS = [
  {
    ...
    className:
      "group relative col-span-2 row-span-2 aspect-[3/4] overflow-hidden border border-primary/10 md:col-span-1",
  ...
  },
  {
    ...
    className:
      "group relative col-span-1 aspect-square overflow-hidden border border-primary/10",
  ...
  },
  {
    ...
    className:
      "group relative col-span-1 aspect-[4/3] overflow-hidden border border-primary/10 md:col-span-2",
  ...
  },
  {
    ...
    className:
      "group relative col-span-2 row-span-2 aspect-[3/4] overflow-hidden border border-primary/10 md:col-span-1 md:-mt-32",
    sizes: "(min-width: 768px) 25vw, 100vw",
  },
];
    ...
    >
      <Reveal className="mx-auto max-w-[1440px]">
        <div className="mb-12 flex items-end justify-between">
          ...
          <a
            href="#"
            className="hidden border-b border-primary pb-1 font-label-sm text-label-sm uppercase tracking-widest transition-colors hover:text-accent md:inline-block"
          >
            Ver Archivo
          </a>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-8">
          {GALLERY_ITEMS.map((item) => (
            <GrainImage
              ...
              imageClassName="object-cover [filter:grayscale(1)_contrast(1.1)] transition-transform duration-[900ms] ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:scale-[1.05]"
              sizes={item.sizes}
            >
              <div className="pointer-events-none absolute inset-0 bg-surface-dark/0 transition-colors duration-700 group-hover:bg-surface-dark/20" />
            </GrainImage>
          ))}
        </div>
      </Reveal>
